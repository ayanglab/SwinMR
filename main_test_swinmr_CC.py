...
from utils.utils_Sobel import sobel
...
def main(json_path):
    ...
    for idx, test_data in enumerate(test_loader):
        ...
        cv2.imwrite(os.path.join(save_dir, 'Edge_ZF', 'Edge_ZF_{:05d}.png'.format(idx)), edge_lq)
        cv2.imwrite(os.path.join(save_dir, 'Edge_GT', 'Edge_GT_{:05d}.png'.format(idx)), edge_gt)
        cv2.imwrite(os.path.join(save_dir, 'Edge_Recon', 'Edge_Recon_{:05d}.png'.format(idx)), edge_gen)
        ...
        cv2.imwrite(os.path.join(save_dir, 'Different', 'Diff_Edge_Recon_{:05d}.png'.format(idx)), diff_edge_gen_x10_color)
        cv2.imwrite(os.path.join(save_dir, 'Different', 'Diff_Edge_ZF_{:05d}.png'.format(idx)), diff_edge_lq_x10_color)
...
if __name__ == '__main__':
    ...
    # # Test SwinMR Channel
    # main('options/SwinMR/test/channel/test_swinmr_npi_C90.json')
    # main('options/SwinMR/test/channel/test_swinmr_npi_C120.json')
    # main('options/SwinMR/test/channel/test_swinmr_npi_C150.json')
    # main('options/SwinMR/test/channel/test_swinmr_npi_C210.json')
    # main('options/SwinMR/test/channel/test_swinmr_npi_C240.json')
    # main('options/SwinMR/test/channel/test_swinmr_pi_C90.json')
    # main('options/SwinMR/test/channel/test_swinmr_pi_C120.json')
    # main('options/SwinMR/test/channel/test_swinmr_pi_C150.json')
    # main('options/SwinMR/test/channel/test_swinmr_pi_C210.json')
    # main('options/SwinMR/test/channel/test_swinmr_pi_C240.json')

    # Test SwinMR Loss
    # main('options/SwinMR/test/loss/test_swinmr_npi_P.json')
    # main('options/SwinMR/test/loss/test_swinmr_npi_PF.json')
    # main('options/SwinMR/test/loss/test_swinmr_npi_PP.json')
    # main('options/SwinMR/test/loss/test_swinmr_pi_P.json')
    # main('options/SwinMR/test/loss/test_swinmr_pi_PF.json')
    # main('options/SwinMR/test/loss/test_swinmr_pi_PP.json')
    #
    # # Test SwinMR Patch Size
    # main('options/SwinMR/test/patch_size/test_swinmr_npi_ps16.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_npi_ps32.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_npi_ps48.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_npi_ps64.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_npi_ps80.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_npi_ps96.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_npi_ps112.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_npi_ps128.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_npi_ps144.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_pi_ps16.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_pi_ps32.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_pi_ps48.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_pi_ps64.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_pi_ps80.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_pi_ps96.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_pi_ps112.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_pi_ps128.json')
    # main('options/SwinMR/test/patch_size/test_swinmr_pi_ps144.json')

    # Test SwinMR Mask
    # main('options/SwinMR/test/mask/test_swinmr_npi_G1D10.json')
    # main('options/SwinMR/test/mask/test_swinmr_npi_G1D30.json')
    # main('options/SwinMR/test/mask/test_swinmr_npi_G1D50.json')
    # main('options/SwinMR/test/mask/test_swinmr_npi_G2D10.json')
    # main('options/SwinMR/test/mask/test_swinmr_npi_G2D30.json')
    # main('options/SwinMR/test/mask/test_swinmr_npi_G2D50.json')
    # main('options/SwinMR/test/mask/test_swinmr_npi_R10.json')
    # main('options/SwinMR/test/mask/test_swinmr_npi_S10.json')
    # main('options/SwinMR/test/mask/test_swinmr_pi_G1D10.json')
    # main('options/SwinMR/test/mask/test_swinmr_pi_G1D30.json')
    # main('options/SwinMR/test/mask/test_swinmr_pi_G1D50.json')
    # main('options/SwinMR/test/mask/test_swinmr_pi_G2D10.json')
    # main('options/SwinMR/test/mask/test_swinmr_pi_G2D30.json')
    # main('options/SwinMR/test/mask/test_swinmr_pi_G2D50.json')
    # main('options/SwinMR/test/mask/test_swinmr_pi_R10.json')
    # main('options/SwinMR/test/mask/test_swinmr_pi_S10.json')

    # Test SwinMR Noise
    # main('options/SwinMR/test/noise/test_swinmr_npi_nl20.json')
    # main('options/SwinMR/test/noise/test_swinmr_npi_nl30.json')
    # main('options/SwinMR/test/noise/test_swinmr_npi_nl50.json')
    # main('options/SwinMR/test/noise/test_swinmr_npi_nl70.json')
    # main('options/SwinMR/test/noise/test_swinmr_npi_nl80.json')
    # main('options/SwinMR/test/noise/test_swinmr_pi_nl20.json')
    # main('options/SwinMR/test/noise/test_swinmr_pi_nl30.json')
    # main('options/SwinMR/test/noise/test_swinmr_pi_nl50.json')
    # main('options/SwinMR/test/noise/test_swinmr_pi_nl70.json')
    # main('options/SwinMR/test/noise/test_swinmr_pi_nl80.json')

    # # Test SwinMR CCnpi perturbation
    # main('options/SwinMR/test/perturbation/test_swinmr_single_CCnpi_G1D30_perturbation.json')
    # main('options/SwinMR/test/perturbation/test_swinmr_single_CCnpi_G2D30_perturbation.json')
